...
<Link href='./drivers' className="flex flex-col items-center gap-y-1 justify-center">
<div className="p-5  text-green-500  bg-green-100 flex items-center justify-center rounded-full">
<svg className="w-7 h-7 "  stroke="currentColor" fill="currentColor" height={512} viewBox="0 0 24 24" width={512} xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"><path d="m7.5 13a4.5 4.5 0 1 1 4.5-4.5 4.505 4.505 0 0 1 -4.5 4.5zm6.5 11h-13a1 1 0 0 1 -1-1v-.5a7.5 7.5 0 0 1 15 0v.5a1 1 0 0 1 -1 1zm3.5-15a4.5 4.5 0 1 1 4.5-4.5 4.505 4.505 0 0 1 -4.5 4.5zm-1.421 2.021a6.825 6.825 0 0 0 -4.67 2.831 9.537 9.537 0 0 1 4.914 5.148h6.677a1 1 0 0 0 1-1v-.038a7.008 7.008 0 0 0 -7.921-6.941z" /></svg>

</div>
<div className=" text-sm font-semibold">خبراء السير</div>
</Link>


<Link href='./select-shift' className="flex flex-col items-center gap-y-1 justify-center">
...
<div className=" text-sm font-semibold">الجدول</div>
</Link>
<Link href='./patrols/select' className="flex flex-col items-center gap-y-1 justify-center">
<div className="p-5  text-blue-500  bg-blue-100 flex items-center justify-center rounded-full">
<svg className="w-7 h-7 "  stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 256 256" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path d="M96,24a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H104A8,8,0,0,1,96,24Zm152,88a8,8,0,0,1-8,8h-8v80a16,16,0,0,1-16,16H192a16,16,0,0,1-16-16v-8H80v8a16,16,0,0,1-16,16H40a16,16,0,0,1-16-16V120H16a8,8,0,0,1,0-16H27.36L54.75,56.06A16,16,0,0,1,68.64,48H187.36a16,16,0,0,1,13.89,8.06L228.64,104H240A8,8,0,0,1,248,112ZM88,144a8,8,0,0,0-8-8H56a8,8,0,0,0,0,16H80A8,8,0,0,0,88,144Zm120,0a8,8,0,0,0-8-8H176a8,8,0,0,0,0,16h24A8,8,0,0,0,208,144Zm2.21-40L187.36,64H68.64L45.79,104Z"></path></svg>
</div>
<div className=" text-sm font-semibold">الدوريات</div>
</Link>
