...
export default function Nav({userId}){
  ...
  <Link href={reportsUrl} className="flex items-center flex-col  justify-center rounded-lg bg-white p-2 gap-y-2 hover:bg-gray-100">
    ...
    <span className="text-gray-600 text-sm font-semibold ">الأحداث</span>
  </Link>
  <Link href={cartToolsUrl} className="flex items-center flex-col  justify-center rounded-lg bg-white p-2 gap-y-2 hover:bg-gray-100">
    ...
    <span className="text-gray-600 text-sm font-semibold ">سجلات التسليم </span>
  </Link>
  <Link href={noteUrl} className="flex items-center flex-col  justify-center rounded-lg bg-white p-2 gap-y-2 hover:bg-gray-100">
    ...
    <span className="text-gray-600 text-sm font-semibold ">الملاحظات</span>
  </Link>
</div>
}